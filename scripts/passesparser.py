...
def parse(begin, end, instr):
    ...
    while cur < end:
        ...
        if c in ",":
            ...
            assert instr[cur - 1] == ")"
            key += "()"
            subtree = parse(begin, cur - 1, instr)
